"""Tests for pebble.console.server._validate_regex_pattern.
...
from pebble.console.server import _validate_regex_pattern
from pebble.core.deadline import DeadlineExceededError
...
def test_catastrophic_backtracking_returns_message(monkeypatch) -> None:
    ...
    monkeypatch.setattr("pebble.console.server.run_with_deadline", _deadline)
...
def test_probe_error_returns_generic_message(monkeypatch) -> None:
    ...
    monkeypatch.setattr("pebble.console.server.run_with_deadline", _err)

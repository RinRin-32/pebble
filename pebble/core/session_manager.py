...
class SessionManager:
    ...
    def discard(self, ws_id: str) -> bool:
        ...
        ``pebble.core.memory.delete_workstream(ws_id)`` separately
    ...
    def delete(self, ws_id: str, *, name: str = "") -> bool:
        ...
        :func:`pebble.core.memory.delete_workstream` before invoking
    ...
    def _reserve_and_install_locked(
        ...
        *,
        ...
        if len(self._workstreams) >= self._max_active:
            ...
            try:
                from pebble.core.metrics import metrics as _m

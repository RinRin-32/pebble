...
_RE_ENV_SECRET_KEY = re.compile(
    ...
    r"|(?:^|_)KEY(?:_|$)"
    r"|^(?:DATABASE_URL|PEBBLE_DB_URL|DB_URL)$",
    re.IGNORECASE,
)
...
# workstream attribution — see :mod:`pebble.core.fence`).  None of these is
    ...
    *,
    ...
    Args:
        ...
        trusted_marker_nonce: This session's operator-fence nonce (see
            :mod:`pebble.core.fence`).  When set, tool output is scanned for

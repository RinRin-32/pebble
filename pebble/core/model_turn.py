...
response as an assistant :class:`~pebble.core.trajectory.Turn` carrying
...
from pebble.core.providers._protocol import drain_stream
from pebble.core.storage._utils import (
    _CLIENT_TOOL_CALL_BLOCK_TYPES,
    strip_orphan_client_tool_blocks,
)
from pebble.core.trajectory import ProviderNative, ToolCall, Turn, dicts_from_turns
...
def provider_extra_params(
    ...
    *cfg* accepts a pre-fetched ModelConfig (see :func:`resolve_lane`).
    """
    from pebble.core.server_compat import merge_server_compat

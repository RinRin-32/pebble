...
from pebble.core.attachments import AUDIO_MIME_TO_FORMAT, unreadable_placeholder
...
# :class:`pebble.core.mcp_crypto.MCPTokenStore` — live in one place and
...
def scan_skill_content(content: str, allowed_tools: str) -> tuple[str, str, str]:
    ...
    """
    try:
        from pebble.core.skill_scanner import SCANNER_VERSION, scan_skill
...
def reconstruct_messages(
    ...
    *,
    ...
    send-time repair (:func:`pebble.core.lowering.repair_wire_messages`), the

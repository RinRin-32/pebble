...
the speech-to-text fallback in :mod:`pebble.core.audio`: a model-role alias
...
The call goes through :func:`pebble.core.model_turn.model_turn` (the shared
...
from pebble.core.trajectory import AttachmentRef, Role, TextBlock, Turn

...
def _build_registry() -> dict[str, SettingDef]:
    ...
    defs: list[SettingDef] = [
        ...
        SettingDef(
            ...
            "Overrides $PEBBLE_SEARXNG_URL and config.toml [tools] searxng_url. Empty "
        ...
        SettingDef(
            ...
            "Overrides $PEBBLE_SEARXNG_ENGINES and config.toml [tools] searxng_engines.",
        ),
        SettingDef(
        ...
        SettingDef(
            ...
            "short-lived certificates for mutual TLS. Requires lacme: pip install pebble-orchestrator[tls]",
        ),
        SettingDef(
            "tls.acme_directory",
            "str",

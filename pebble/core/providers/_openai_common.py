...
from pebble.core.lowering import CANCELLED_TOOL_RESULT
...
def inline_document_parts(parts: list[Any], *, skip_pdf_inline: bool = False) -> list[Any]:
    ...
    lane's :func:`~pebble.core.providers._openai_responses.convert_content_parts`
...
def sanitize_messages(
    ...
    *,
    ...
    :func:`pebble.core.lowering.repair_wire_messages`, so by here every

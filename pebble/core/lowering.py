...
from pebble.core.trajectory import EffectStatus, Turn, dicts_from_turns
...
def fold_system_turns(
    ...
    *,
    ...
    (:func:`pebble.core.fence.wrap`) — the system prompt declares the exact
...
def _neutralize_host(msg: dict[str, Any]) -> dict[str, Any]:
    ...
    :func:`pebble.core.fence.neutralize` (opening + closing) so a leaked or

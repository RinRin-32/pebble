...
# ``pebble.console.coordinator_client`` import this so a future rename
...
def sanitize_error_text(text: str, *, max_len: int = LAST_ERROR_MAX_LEN) -> str:
    ...
    :func:`pebble.core.output_guard.redact_credentials` — the same
    ...
    # every consumer of ``pebble.core.memory``.  The fatal-error

...
if TYPE_CHECKING:
    ...
    from pebble.core.mcp_crypto import MCPTokenStore, MCPUserTokenPlain
        ...
        return JSONResponse(
            {
                ...
                "hint": (
                    ...
                    "PEBBLE_OIDC_REDIRECT_BASE) to the service's "
...
async def initialize_mcp_oauth_state(app_state: Any) -> None:
    ...
    Mirrors :func:`pebble.core.oidc.initialize_oidc_state` so the

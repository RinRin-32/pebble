...
/ wrap) lives in :mod:`pebble.core.fence`, shared with the output-guard judge
...
# metacognition nudge types (``pebble.core.metacognition._NUDGE_MAP``) — kept
...
def make_system_turn(source: str, content: str, **meta: Any) -> dict[str, Any]:
    ...
    *source* must be one of :data:`SYSTEM_TURN_SOURCES`.
    ...
    ["source_meta"]`` field (via :func:`pebble.core.trajectory.turn_from_dict`),
    ...
    :func:`pebble.core.fence.wrap` (applied in

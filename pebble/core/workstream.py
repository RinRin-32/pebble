...
on :class:`pebble.core.session_manager.SessionManager`; this module only
...
class _PendingSend:
    ...
    :func:`pebble.core.session_routes._drain_pending_sends` dispatches
    ...
    (:func:`pebble.core.session_routes._make_dispatch_attempt` with
...
class Workstream:
    ...
    # Toggled under ``_lock`` by ``pebble.core.session_worker.send``

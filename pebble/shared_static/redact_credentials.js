...
// Mirrors the backend patterns in pebble/core/output_guard.py so the
...
const _RE_ENV_SECRET_KEY =
  /(?:^|_)(?:SECRET|TOKEN|PASSWORD|CREDENTIAL|DSN)(?:_|$)|(?:^|_)KEY(?:_|$)|^(?:DATABASE_URL|PEBBLE_DB_URL|DB_URL)$/i;

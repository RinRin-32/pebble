"""Typed HTTP clients for the pebble server API.
...
from pebble.sdk._types import AttachmentUpload, TurnResult
...
class AsyncTurnstoneServer(_BaseClient):
    """Async client for the pebble server API."""
...
class TurnstoneServer:
    """Synchronous client for the pebble server API.

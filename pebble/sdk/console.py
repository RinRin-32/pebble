"""Typed HTTP clients for the pebble console API.

Usage::

    from pebble.sdk import TurnstoneConsole
...
from pebble.api.schemas import (
    AuthLoginResponse,
    AuthSetupResponse,
    AuthStatusResponse,
...
from pebble.api.server_schemas import (
    ListAttachmentsResponse,
    ListPersonaChoicesResponse,
    UploadAttachmentResponse,
)
from pebble.sdk._base import _BaseClient
from pebble.sdk._sync import _SyncRunner
from pebble.sdk.events import ClusterEvent
...
class AsyncTurnstoneConsole(_BaseClient):
    """Async client for the pebble console API."""
...
class TurnstoneConsole:
    """Synchronous client for the pebble console API.

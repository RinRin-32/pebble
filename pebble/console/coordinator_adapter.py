...
from pebble.core.adapters._ui_cleanup import cleanup_session_ui
...
from pebble.core.memory import get_workstream_display_name, get_workstream_display_names
from pebble.core.storage import is_storage_initialized
...
class CoordinatorAdapter:
    ...
    def __init__(
        ...
        *,
        ...
        # ``pebble.core.children_registry.ChildrenRegistry`` (Stage 3
    ...
    # ------------------------------------------------------------------
    # Worker dispatch — delegates to pebble.core.session_worker
    # ------------------------------------------------------------------
    ...
    def send(
        ...
        *,
        ...
        :func:`pebble.core.session_worker.send`; the closures below
        ...
        :func:`pebble.core.attachments.resolve_staged_attachments`; the

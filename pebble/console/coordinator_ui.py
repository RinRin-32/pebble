...
Mirrors ``pebble.server.WebUI`` but scoped to the console's needs:
...
Contract: this class must conform to :class:`pebble.core.session.SessionUI`.
"""
...
from pebble.core.session_ui_base import SessionUIBase, fire_judge_verdict_metric

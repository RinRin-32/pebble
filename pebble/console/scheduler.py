...
the :class:`~pebble.sdk.server.TurnstoneServer` SDK client.
...
from pebble.sdk.server import TurnstoneServer
...
class TaskScheduler:
    ...
    def _compute_next_run(task: dict[str, Any]) -> str:
        ...
        from pebble.console.server import _compute_next_run
